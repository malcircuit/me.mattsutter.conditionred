 ...
 *
 */
public class SRVPalette implements Palette {
	...
	public void setInterpValues(int[] thresh){
		...
		// TODO: make sure you fix this if you decide to get Digital SRV working.
		//av_speed = ((float)ave_speed)/10.0f;
		//av_dir = ((float)ave_dir)/10.0f;
	}
